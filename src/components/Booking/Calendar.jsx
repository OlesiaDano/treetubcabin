import { Datepicker, CalendarPrev, CalendarNav, CalendarNext, CalendarToday, formatDate, getJson, 
    // setOptions, 
    localeUa } from '@mobiscroll/react-lite';
...
export function Calendar() {
    ...
    useEffect(() => {
        const monthColors = [{
            ...
            background: '#a3cdff80',
            start: '2023-03-01T00:00',
            end: '2023-03-31T23:59',
        ...
        getJson('https://trial.mobiscroll.com/getrentals/?year=' + now.getFullYear() + '&month=' + now.getMonth(), (data) => {
